...
NOTE (2026-08-10): mind/luts/rsqrt_q16.mind is hand-maintained — it was
split out of this generator's sqrt_q16.mind output and is NOT rewritten
here. Regeneration therefore cannot clobber it, but conversely any table
change to rsqrt must be ported by hand. Always review `git diff` after
running this script.
"""
...
def write_softmax_q16() -> None:
    src = (
        ...
        + """\
// Stage 2 calls exp_q16_lookup (mind/luts/exp_q16.mind); the import is
// required — mindc >= 0.10 name-checks fn bodies (mind#23).
import luts.exp_q16;
